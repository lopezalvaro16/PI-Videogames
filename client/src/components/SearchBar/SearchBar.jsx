  ...
  return (
    <div className={style.searchBar}>
      ...
      <div className={style.divSearchName}>
        <div className={style.divSearchNameTitulo}></div>
        <div className={style.divSearchNameInput}>
          ...
          />
          <button className={style.button} onClick={() => getGameByName(name)}>
            Search
          </button>
        </div>
      </div>
      ...
      <div className={style.divSearchGenre}>
        ...
        <div className={style.divSearchGenreSelect}>
          ...
          >
            ...
            {allGenres.map((genre) => (
              <option key={genre.idGenreRawg}>{genre.name}</option>
            ))}
          </select>
          <button onClick={() => filterBYGenre(genre)} className={style.button}>
            Search
          </button>
        </div>
      </div>
